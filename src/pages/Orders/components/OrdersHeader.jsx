...
import { RefreshCcw, Search, ShoppingBag, Filter } from 'lucide-react'
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-gray-500 text-sm mt-1">Управление заказами и их статусами</p>
          </div>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-6 lg:items-end">
          ...
          <div className="flex flex-col lg:flex-row gap-4 flex-1">
            <div className="flex flex-col flex-1 min-w-[280px]">
              <label className="text-sm font-medium text-gray-700 mb-2">Поиск заказов</label>
              <div className="relative">
                <input
                  type="text"
                  placeholder="№ заказа или телефон клиента"
                  value={searchQuery}
