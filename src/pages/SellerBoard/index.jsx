  ...
  return (
    <div className="h-full flex flex-col items-center justify-center p-8">
      <div className="bg-gray-800 p-12 rounded-lg border border-gray-700 text-center max-w-2xl">
        <h2 className="text-4xl font-bold text-white mb-4">📊 Борд заказов</h2>
        <p className="text-gray-400 text-lg mb-6">Сайт: <span className="text-green-400 font-semibold">{siteName}</span></p>
        
        <div className="bg-gray-900 p-8 rounded mb-6 border-l-4 border-green-400">
